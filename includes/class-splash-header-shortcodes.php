...
/**
 * Fired during plugin shortcode.
 *
 * This class defines all code necessary to run during the plugin's shortcode.
 *
 * @since      1.0.0
 * @package    Plugin_Name
 * @subpackage Plugin_Name/includes
...
class Splash_Header_Shortcodes {
    ...
    if ($enabled) {
        ...
        if ($message_text_align != '')
            $message_text_align = $text_align_element . $message_text_align . '!important;';
        ...
        if ($message_font_size != '' || $message_color != '' || $message_font_weight != '' || $message_font_style != '' || $message_font_decoration != '' || $message_text_align != '')
            $style_message = $message_font_size . $message_text_align . $message_color . $message_font_weight . $message_font_style . $message_font_decoration;
    }
    ...
    if (isset($title) && $title != '') {
        $title_div = '<h3 class="sh-title" style="' . $title_color . $title_font_size . $title_text_align . $title_font_weight . $title_font_style . $title_font_decoration . 'margin:10px 0 0 0">' . $title . '</h3>';
    }
    ...
    if ($enabled_links_1) {
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            if (get_option('sh_link_text_align_' . $i) != '') {
                $font_text_align_1 = $text_align_element . get_option('sh_link_text_align_' . $i) . ";";
            }
            ...
            if ($font_size_1 != '' || $font_color_1 != '' || $font_weight_1 != '' || $font_style_1 != '' || $font_decoration_1 != '' || $font_text_align_1 != '') {
                $style_1 = 'style="' . $font_size_1 . $font_color_1 . $font_weight_1 . $font_style_1 . $font_decoration_1 . $font_text_align_1 . '"';
            }
    ...
    if ($enabled_links_2) {
        ...
        for ($i = 4; $i <= 6; $i++) {
            ...
            if (get_option('sh_link_text_align_' . $i) != '') {
                $font_text_align_2 = $text_align_element . get_option('sh_link_text_align_' . $i) . ";";
            }
            ...
            // set font style  
            if ($font_size_2 != '' || $font_color_2 != '' || $font_weight_2 != '' || $font_style_2 != '' || $font_decoration_2 != '' || $font_text_align_2 != '') {
                $style_2 = 'style="' . $font_size_2 . $font_color_2 . $font_weight_2 . $font_style_2 . $font_decoration_2 . $font_text_align_2 . '"';
            }
            // set font icon 
            if (get_option('sh_font_icon_' . $i) != '') {
